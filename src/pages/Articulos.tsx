    ...
    <Layout>
      <section className="bg-catholic-primary text-white py-12">
        <div className="container mx-auto px-4 text-center">
          <h1 className="font-serif text-3xl md:text-5xl font-bold mb-6">Artículos</h1>
          <p className="text-lg md:text-xl max-w-3xl mx-auto">
            Explora nuestra colección de artículos sobre la fe católica, teología, historia y espiritualidad.
          </p>
        </div>
      </section>
